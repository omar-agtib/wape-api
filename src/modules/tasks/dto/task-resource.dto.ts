...
export class AddTaskPersonnelDto {
  ...
  @ApiPropertyOptional({
    example: 150.0,
    description: 'Pre-filled from personnel.costPerHour, overridable',
  })
  @IsOptional()
  @IsNumber({ maxDecimalPlaces: 2 })
  @Min(0)
...
export class AddTaskArticleDto {
  ...
  @ApiPropertyOptional({
    example: 85.0,
    description: 'Pre-filled from article.unitPrice, overridable',
  })
  @IsOptional()
  @IsNumber({ maxDecimalPlaces: 2 })
  @Min(0)
...
export class AddTaskToolDto {
  ...
  @ApiPropertyOptional({
    example: 1200.0,
    description: 'Daily cost — default 0',
  })
  @IsOptional()
  @IsNumber({ maxDecimalPlaces: 2 })
  @Min(0)
