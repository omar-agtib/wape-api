...
export class ProjectFinanceSnapshot extends BaseEntity {
  ...
  @Column({
    type: 'decimal', precision: 15, scale: 2,
    name: 'remaining_budget', default: 0,
    transformer: DecimalTransformer,
  })
  ...
  @Column({
    type: 'decimal', precision: 15, scale: 2,
    name: 'spent_personnel', default: 0,
    transformer: DecimalTransformer,
  })
